...
namespace Portal.Controllers.Admin
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            // LookUpList tablosundan Cinsiyet LookUpId = 1 olanları al
            ...
            // LookUpList tablosundan Öğrenim Durumu LookUpId = 4 olanları al
        ...
        public IActionResult Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                var user = new User
                {
                    ...
                    Puan = model.Puan ?? "0",
                    Phone = model.Phone,
                    CinsiyetId = model.CinsiyetId, // Cinsiyet LookUpList'ten gelen Id
                    OgrenimDurumuId = model.OgrenimDurumuId, // Öğrenim durumu LookUpList'ten gelen Id
                    KayitTarihi = DateTime.Now // Kayıt tarihi atanıyor

                };

                // ViewBag yeniden doldurulmalı, çünkü ModelState geçersiz olduğunda View tekrar render edilir
                ViewBag.Cinsiyetler = new SelectList(
                    _context.LookUpLists.Where(l => l.LookUpId == 1).ToList(),
                    "Id",
                    "Name"
