...
namespace Portal.Migrations
{
    ...
    [Migration("20241119114925_AddKayitTarihiToUser")]
    partial class AddKayitTarihiToUser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Portal.Models.Admin.LookUp", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Portal.Models.Admin.LookUpList", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Portal.Models.Admin.User", b =>
                {
                    ...
                    b.Property<int?>("OgrenimDurumuId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("EhliyetId");

                    b.HasIndex("KanGrubuId");

                    b.HasIndex("MedeniDurumId");

                    b.HasIndex("OgrenimDurumuId");
            ...
            modelBuilder.Entity("Portal.Models.Admin.LookUpList", b =>
                {
                    b.HasOne("Portal.Models.Admin.LookUp", "LookUp")
            ...
            modelBuilder.Entity("Portal.Models.Admin.User", b =>
                {
                    b.HasOne("Portal.Models.Admin.LookUpList", "Cinsiyet")
                        .WithMany()
                        .HasForeignKey("CinsiyetId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Portal.Models.Admin.LookUpList", "Ehliyet")
                        .WithMany()
                        .HasForeignKey("EhliyetId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Portal.Models.Admin.LookUpList", "KanGrubu")
                        .WithMany()
                        .HasForeignKey("KanGrubuId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Portal.Models.Admin.LookUpList", "MedeniDurum")
                        .WithMany()
                        .HasForeignKey("MedeniDurumId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Portal.Models.Admin.LookUpList", "OgrenimDurumu")
                        .WithMany()
                        .HasForeignKey("OgrenimDurumuId")
                        .OnDelete(DeleteBehavior.Restrict);
